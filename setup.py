...
with open(os.path.join(here, "aspired", "__version__.py")) as f:
    exec(f.read(), about)
...
setup(
    ...
    url="https://github.com/Constructionware/aspireD",
    packages=find_packages(exclude=["tests"]),
    entry_points={"console_scripts": ["aspired=aspired.cli:cli"]},
    package_data={"aspired": ["py.typed"]},
    python_requires=">=3.9",
    setup_requires=[],
